  ...
  if (authMode === 'login') {
    ...
    contentHtml = `
      ...
      <div class="auth-card">
        ...
        <div class="fg" style="margin-bottom:3px;">
          <label style="font-weight:800; color:var(--t1); font-size:12px;">🔒 設定密碼 (至少12位以上，含大小寫/數字/特殊符號)</label>
        ...
        <div style="font-weight:800; color:var(--t1); font-size:12px;">可以使用<a href="https://1password.com/zh-tw/password-generator" target="_blank" rel="noopener noreferrer nofollow">1Password密碼生成器</a>，選擇(隨機)生成密碼。</span><span style="font-weight:600; font-size:12px; color:var(--text-red)">(密碼生成後，請先保存，避免不見)</span></div><br>
