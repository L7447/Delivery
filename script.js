  ...
  if (authMode === 'login') {
    ...
    contentHtml = `
      ...
      <div class="auth-card">
        ...
        <span style="font-weight:800; color:var(--t1); font-size:12px; margin-bottom:3px;">可以使用【密碼生成器】<a href="https://1password.com/zh-tw/password-generator" target="_blank" rel="noopener noreferrer nofollow"> 1Password </a>，選擇【隨機】生成密碼。</span><br>
