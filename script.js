    ...
    <div class="hist-rec-card" style="border: 1.5px solid #708090; box-shadow: 0 4px 10px rgba(0,0,0,0.03);">
      <div class="hrc-top" onclick="foldCard('${cardId}', event)">
        ...
        <div style="display:flex; justify-content:center; gap:6px; margin-top:1px; flex-wrap:wrap; text-align:center;">
          <div style="flex:1; background: rgba(34, 197, 94, 0.15); color: var(--green); padding:2px 2px; border-radius:10px; font-size:11px; font-weight:800; font-family:var(--mono); align-content:center;">
            淨行程：<span style="color: #1f9c4d; font-size:14px;">$${fmt(income)}</span>
          </div>
          <div style="flex:1; background: rgba(245,158,11,0.15); color: var(--gold); padding:6px 4px; border-radius:8px; font-size:11px; font-weight:800; font-family:var(--mono); align-content:center;">
            獎勵：<span style="color: #ff7715; font-size:14px;">$${fmt(totalBonus)}</span>
          </div>
          <div style="flex:1; background: rgba(190, 59, 246, 0.15); color: rgba(137, 43, 226, 0.9); padding:6px 4px; border-radius:8px; font-size:11px; font-weight:800; font-family:var(--mono); align-content:center;">
